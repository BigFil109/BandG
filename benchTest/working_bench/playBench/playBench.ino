...
#define FASTNET_CH_TWA      0x59        // True Wind Angle (standard Fastnet ID)
#define FASTNET_CH_TWS      0x5A        // True Wind Speed (custom but unused ID)
#define FASTNET_CH_VMG      0x5B        // VMG (custom)
#define FASTNET_CH_VOLTAGE  0x8D
#define FASTNET_CH_LIGHTS   0xC9
...
void loop()
{
    ...
    float tws = aws;
    float voltage = 15.6;               // Fake battery
    ...
    fastnet_add_channel(FASTNET_CH_TWA, 8, 0, 0, 22);
    fastnet_add_channel(FASTNET_CH_TWS, 1, 0, 1, 5);
    fastnet_add_channel(FASTNET_CH_VMG, 1, 0, 1, 6);
